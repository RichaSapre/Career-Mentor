  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-6xl grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-auto">
        ...
        {/* Main Hero Card */}
        <div className="md:col-span-12 lg:col-span-8 flex flex-col items-start justify-center overflow-hidden rounded-[2.5rem] bg-surface border border-border backdrop-blur-3xl shadow-card p-8 md:p-14 relative group transition-all duration-500 hover:border-border-hover min-h-[400px]">
        ...
        {/* Login Card */}
        <div className="md:col-span-6 lg:col-span-4 flex flex-col justify-between overflow-hidden rounded-[2.5rem] bg-surface border border-border backdrop-blur-3xl shadow-card p-8 relative group transition-all hover:bg-surface-hover hover:border-border-hover">
        ...
        {/* Register Card */}
        <div className="md:col-span-6 lg:col-span-5 flex flex-col justify-between overflow-hidden rounded-[2.5rem] bg-surface border border-border backdrop-blur-3xl shadow-card p-8 relative group transition-all hover:bg-surface-hover hover:border-border-hover">
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-4">
        ...
        {/* Guest Explorer Card */}
        <div className="md:col-span-12 lg:col-span-7 flex flex-col sm:flex-row items-center justify-between overflow-hidden rounded-[2.5rem] bg-surface border border-border backdrop-blur-3xl shadow-card p-8 relative group transition-all hover:border-border-hover">
